...
mongo_uri = "mongodb+srv://dbThumbtack:db4405787@cluster0.sgm44.mongodb.net/Thumbtacks?retryWrites=true&w=majority".format(username, password)
...
if __name__ == "__main__":
    http_server = WSGIServer(("192.168.1.4", 5000), app)
